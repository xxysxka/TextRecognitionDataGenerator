...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        "--bounding_box",
        action="store_true",
        help="Write each character's boudnging_box coordinate into a txt file",
        default=False,
    )
    parser.add_argument(
        "--draw_bbox",
        action="store_true",
        help="Draw the bounding_obx",
        default=False,
    )
    ...
    parser.add_argument(
        ...
        type=int,
        nargs="?",
        help="Define the radius of the circle in the curved text.",
        default=100,
    )
    ...
    for _ in tqdm(
        p.imap_unordered(
            ...
            zip(
                ...
                [args.draw_bbox] * string_count,
                [args.radius] * string_count,
            ),
        ),
        total=args.count,
    ):
